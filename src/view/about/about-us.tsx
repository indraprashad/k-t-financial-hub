...
export const AboutUs = () => {
    ...
    return (
        <div className="bg-white overflow-hidden">
            {hero && (
                <section className="relative py-20 lg:py-28 bg-gradient-to-br from-slate-50 via-white to-amber-50/30">
                    ...
                    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative">
                        <div className="grid lg:grid-cols-2 gap-16 items-center">
                            <div className="space-y-8 animate-in fade-in slide-in-from-left-8 duration-700">
                                <div className="inline-flex items-center gap-2 px-4 py-2 bg-amber-100/50 rounded-full">
                                ...
                                <button
                                    ...
                                    className="group inline-flex items-center gap-3 px-8 py-4 bg-slate-900 text-white rounded-xl hover:bg-slate-800 hover:shadow-xl hover:shadow-slate-900/20 hover:-translate-y-0.5 transition-all duration-300"
                                >
                            ...
                            <div className="relative lg:pl-8 animate-in fade-in slide-in-from-right-8 duration-700 delay-200">
                                <div className="absolute -inset-4 bg-gradient-to-r from-amber-200/30 to-amber-400/20 rounded-[2.5rem] blur-2xl"></div>
                                {hero.attributes.image ? (
                                    <img
                                        src={hero.attributes.image}
                                        alt=""
                                        className="relative w-full h-96 lg:h-[500px] object-cover rounded-2xl shadow-2xl shadow-slate-900/10"
                                    />
                                ) : (
                                ...
                                <div className="absolute -bottom-8 -right-8 bg-white rounded-2xl p-6 shadow-xl shadow-slate-900/10 border border-slate-100">
                    ...
                    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                        <div className="grid md:grid-cols-2 gap-8">
                            {hero?.attributes?.mission && (
                                <Card className="group border-0 shadow-lg shadow-slate-900/5 hover:shadow-xl hover:shadow-amber-900/5 hover:-translate-y-1 transition-all duration-500 bg-gradient-to-br from-white to-slate-50/50">
                ...
                <section className="py-24 bg-gradient-to-b from-white to-slate-50">
                    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                        <div className="text-center mb-16">
                            <span className="inline-block px-4 py-1.5 bg-amber-100 text-amber-700 rounded-full text-sm font-semibold mb-4">What We Stand For</span>
            ...
            {team.length > 0 && (
                <section className="py-24 bg-slate-50">
                    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                        <div className="text-center mb-16">
                            <span className="inline-block px-4 py-1.5 bg-slate-200 text-slate-700 rounded-full text-sm font-semibold mb-4">The Experts</span>
            ...
            {timeline.length > 0 && (
                <section className="py-24 bg-white relative overflow-hidden">
                    <div className="absolute inset-0 bg-[radial-gradient(ellipse_at_bottom_left,_var(--tw-gradient-stops))] from-amber-100/30 via-transparent to-transparent"></div>
                    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative">
                        <div className="text-center mb-16">
                            <span className="inline-block px-4 py-1.5 bg-amber-100 text-amber-700 rounded-full text-sm font-semibold mb-4">Through The Years</span>
